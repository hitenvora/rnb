...
@section('content')
    ...
    <body>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="breadcome-heading">
                                        ...
                                        " href="{{ route('master_form') }}">
                                            ...
                                            <h3>Subdivision Master</h3>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-end">
                                    {{-- <a class="btn btn-white" id="exportButton" href="#" download>
                                    ...
                                    <a class="btn btn-primary ms-2 add-subdivision" data-bs-toggle="modal" data-bs-target="#add_sub_divison">
                                ...
                                <table class="product-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Subdivision Name</th>
                                    ...
                                    {{-- <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">Abx, PQR, ABC</td>
        ...
        <div class="modal fade product-modal" id="add_sub_divison" tabindex="-1" aria-labelledby="add_sub_divison"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="add_sub_divison">Add Subdivision</h2>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="row" method="post" id="add_subdivision_form" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="subdivision_id" id="subdivision_id">
                            <div class="col-lg-12">
                                <label class="form-label">Divison Name</label>
                                <select class="form-select" name="division_master_id" id="division_master_id">
                                    <option>Select Division</option>
                                    @foreach ($divisionname as $value)
                                        <option value="{{ $value['id'] }}">{{ $value['name'] }}</option>
                                    @endforeach
                                </select>
                                <span class="text-danger" id="division_master_id_error"></span>
                            </div>
                            <div class="col-lg-12">
                                ...
                                {{-- <ul class="d-flex select_menu">
                                    <li>
                                        <a href="#">
                                            Surat
                                            <svg class="close-menu" xmlns="http://www.w3.org/2000/svg" width="8"
                                                height="9" viewBox="0 0 8 9" fill="none">
                                                <g clip-path="url(#clip0_2240_5554)">
                                                    <path d="M7 1.5L1 7.5M1 1.5L7 7.5L1 1.5Z" stroke="black"
                                                        stroke-width="1.5" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </g>
                                                <defs>
                                                    <clipPath id="clip0_2240_5554">
        ...
        <div class="modal fade product-modal" id="editmodal" tabindex="-1" aria-labelledby="editmodal"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="editmodal">Edit Subdivision</h2>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="row" method="post">
                            <div class="col-lg-12">
                                ...
                                <input type="text" class="form-control" id="d_name" name="d_name"
                                    placeholder="Enter Divison Name" value="XYZ">
                            </div>
                            <div class="col-lg-12">
                                <label class="form-label">Subdivision Name</label>
                                <div class="d-flex">
...
@section('script')
    <script>
        ...
        $('.edit-form').hide();
        $(document).on('click', '.add-subdivision', function() {
            $('.modal-title').text('Add Sub Division');
            $('#subdivision_id').val('');
            $("#add_subdivision_form")[0].reset();
            $('span[id$="_error"]').text('');
            $('.edit-form').hide();
            $('add_sub_divison').modal('show');
        });

        $('#add_subdivision_form').submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: (data) => {
                    if (data.status == 200) {
                        $('#add_sub_divison').modal('hide');
                        if ($('#subdivision_id').val() == '') {
                            toastr.success("Sub Division List added successfully.");
                        } else {
                            toastr.success("Sub Division List updated successfully.");
                        }
                        dataTable.draw();
                    } else {
        ...
        var dataTable = $('.product-table').DataTable({
            ...
            ajax: {
                url: "{{ route('get_sub_division_list') }}",
                data: function(d) {
                    d._token = token;
                },
                type: 'POST',
            ...
            columns: [{
                ...
                {
                    data: 'division_name_view',
                    name: 'division_name_view'
                },
        ...
        function editsubdivision(id) {
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    $('.edit-form').show();
                    // set edit value
                    $('#subdivision_id').val(data.data.id);
                    $('#division_master_id').val(data.data.division_master_id);
