...
@section('content')
    ...
    <body>
        ...
        <!-- edit user -->
        {{-- <div class="modal fade product-modal" id="editmodal" tabindex="-1" aria-labelledby="editmodal" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h2 class="modal-title" id="editmodal">Edit User</h2>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body">
						<form class="row"  method="post">
                            ...
                            <div class="col-lg-6">
								<label  class="form-label">Email</label>
                                <input type="text" class="form-control" id="Enter_Email" name="Enter_Email" placeholder="Enter Email">
							</div>
                            ...
                            <div class="col-lg-6">
								...
								<select class="form-select" name="Role" id="Role">
                                    ...
                                    <option value="Auditor/Account">Auditor/Account</option>
                                    <option value="Tender Branch">Tender Branch</option>
                                  </select>
							</div>
							<div class="col-12 text-center">
								<button type="submit" class="btn submit-btn" id="btn_save" name="btn_save">Save</button>
							</div>
						</form>
					</div>
				</div>
