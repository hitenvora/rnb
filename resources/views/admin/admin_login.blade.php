            ...
            <div class="content-error">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        @endforeach
                    @endif
                        <form action="{{ route('admin_login_submit') }}" method="post" id="loginForm" class="row login-form-main-section">
                            @csrf
                            <h5 class="text-center mg-b-30 loginfrom-heading">Login to your account</h5>

                            <div class="form-group col-12">
                                <label class="form-label">User Name</label>
                                <input type="text" placeholder="Enter your User Name"  name="name" id="name" class="form-control" title="User Name">
                            </div>
