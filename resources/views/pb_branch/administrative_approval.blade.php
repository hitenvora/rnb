                            ...
                            <div class="card-body">
                                ...
                                <form class="row" method="post" enctype="multipart/form-data" id="master_id">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="date" class="form-control" id="" name="aa_letter_date"
                                            value="aa_letter_date">
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea rows="9" class="form-control" id="aa_detail_regarding_architecture"
                                            ...
                                            placeholder="Enter Detail Regarding Architecture/Structural Drawings, If Any"></textarea>
                                    </div>
