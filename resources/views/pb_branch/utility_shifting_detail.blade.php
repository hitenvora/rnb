                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="text" class="form-control" name="usd_utility_item"
                                                            id="usd_utility_item" value="XYZ">
                                                    ...
                                                    <td>
                                                        <input type="text" name="estimated_usd_latter_no"
                                                            class="form-control class_code" id="estimated_usd_latter_no"
                                                            value="12045">
                                                    </td>

                                                    <td>
                                                        <input type="date" name="usd_date_input" class="form-control"
                                                            id="usd_date_input" value="14/09/2023">
                                                    </td>

                                                    <td>
                                                        <input type="text" name="usd_submitted_to"
                                                            class="form-control" id="usd_submitted_to" value="-">
                                                    </td>

                                                    <td>
                                                        <select class="form-select joint-date-visit" id="usd_joint_visit"
                                                            name="usd_joint_visit">
                                                    ...
                                                    <td>
                                                        <input type="text" name="usd_latter_no" class="form-control"
                                                            id="usd_latter_no" value="12045">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="text" name="usd_amount" class="form-control "
                                                            id="usd_amount" value="1000">
                                                    </td>

                                                    <td>
                                                        <select class="form-select" id="usd_payment" name="usd_payment">
