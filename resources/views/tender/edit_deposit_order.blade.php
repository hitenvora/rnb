                            ...
                            <div class="card-body">
                                <form class="row" method="post" enctype="multipart/form-data" id="master_id">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control w-100" id="do_letter_upload_img"
                                                name="do_letter_upload_img" value="{{ $project_master->do_letter_upload_img }}">
                                                <a href="{{ asset('uplode_images/deposit_order_bank_guarantee_detail/' . $project_master->do_letter_upload_img) }}" target="_blank">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <select class="form-select" id="do_above"
                                                            name="do_above">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input class="form-control" type="text" id="do_above_perc" name="do_above_perc"
                                            placeholder="Enter bove / Below (%)" value="{{ $project_master->do_above_perc }}">
                                    </div>
                                            ...
                                            <div class="row p-0">
                                                <div class="col-xl-2 col-lg-6">
                                                    ...
                                                    <input class="form-control" type="text" id="do_deposit_letter_no"
                                                        name="do_deposit_letter_no" placeholder="Enter Letter No." value="{{ $project_master->do_deposit_letter_no }}">
                                                </div>
                                                <div class="col-xl-2 col-lg-6">
                                                ...
                                                <div class="col-xl-2 col-lg-6">
                                                    ...
                                                    <input class="form-control" type="text" id="do_deposit_letter_amount" name="do_deposit_letter_amount"
                                                        placeholder="Enter amount" value="{{ $project_master->do_deposit_letter_amount }}">
                                                </div>
                                                <div class="col-xl-6 col-lg-6">
                                                    <label class="form-label">Letter Upload</label>
                                                    <div class="input-group">
                                                        <input type="file" class="form-control w-100" id="do_deposit_letter_upload"
                                                            name="do_deposit_letter_upload" value="{{ $project_master->do_deposit_letter_upload }}">
                                                            <a href="{{ asset('uplode_images/deposit_order_bank_guarantee_detail/' . $project_master->do_deposit_letter_upload) }}" target="_blank">
                                                                <br>Open Image in New Tab
                                                            </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row p-0">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="date" class="form-control" id="do_submit_date"
                                                        name="do_submit_date" value="{{ $project_master->do_submit_date }}">
                                                </div>
                                                <div class="col-lg-4">
                                                    <label for="inputtitle1" class="form-label">Amount</label>
                                                    <input class="form-control" type="text" id="do_submit_amount"
                                                        name="do_submit_amount" placeholder="Enter amount" value="{{ $project_master->do_submit_amount }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row p-0">
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="date" class="form-control" id="do_bg_exp_date"
                                                        name="do_bg_exp_date" value="{{ $project_master->do_bg_exp_date }}">
                                                </div>
                                                <div class="col-lg-3">
                                                    <label for="inputtitle1" class="form-label">Amount</label>
                                                    <input class="form-control" type="text" id="do_bg_exp_amount"
                                                        name="do_bg_exp_amount" placeholder="Enter amount" value="{{ $project_master->do_bg_exp_amount }}">
                                                </div>
                                                <div class="col-lg-6">
                                                    <label class="form-label">Letter Upload</label>
                                                    <div class="input-group">
                                                        <input type="file" class="form-control w-100" id="do_bg_exp_image"
                                                            name="do_bg_exp_image" value="{{ $project_master->do_bg_exp_image }}">
                                                            <a href="{{ asset('uplode_images/deposit_order_bank_guarantee_detail/' . $project_master->do_bg_exp_image) }}" target="_blank">
                                                                <br>Open Image in New Tab
                                                            </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row p-0">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input class="form-control" type="text" id="do_fdr_amount"
                                                        name="do_fdr_amount" placeholder="Enter amount" value="{{ $project_master->do_fdr_amount }}">
                                                </div>
                                                <div class="col-lg-6">
                                                    <label class="form-label">Letter Upload</label>
                                                    <div class="input-group">
                                                        <input type="file" class="form-control w-100" id="do_fdr_image"
                                                            name="do_fdr_image" value="{{ $project_master->do_fdr_image }}">
                                                            <a href="{{ asset('uplode_images/deposit_order_bank_guarantee_detail/' . $project_master->do_fdr_image) }}" target="_blank">
                                                                <br>Open Image in New Tab
                                                            </a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-xl-3 col-lg-6">
                                        ...
                                        <input class="form-control" type="text" id="do_time_line_month" name="do_time_line_month"
                                            placeholder="Enter Time Line As Per Work Order In Month" value="{{ $project_master->do_time_line_month }}">
                                    </div>
                                    <div class="col-xl-3 col-lg-6">
                                        ...
                                        <input class="form-control" type="text" id="do_time_limit_any" name="do_time_limit_any"
                                            placeholder="Enter Time Limit Extension If Any" value="{{ $project_master->do_time_limit_any }}">
                                    </div>
                                    <div class="col-xl-3 col-lg-6">
