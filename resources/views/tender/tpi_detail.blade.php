                                        ...
                                        <div class="contact_list">
                                            ...
                                            <div class="row pt-2" method="post">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input class="form-control" type="date" id="tpi_proposal_latter_date"
                                                        name="tpi_proposal_latter_date" value="2023-09-16">
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="file" class="form-control w-100"
                                                            id="tpi_proposal_latter_image" name="tpi_proposal_latter_image">
                                                    </div>
                                                </div>
