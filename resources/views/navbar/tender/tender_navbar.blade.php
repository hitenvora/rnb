                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <ul class="nav branch_listing">
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('dtp_approval') ? 'active' : '' }}"
                                                href="{{ route('dtp_approval') }}">DTP Approval Detail</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link  {{ Route::is('nit') ? 'active' : '' }}"
                                                href="{{ route('nit') }}">NIT</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('deposit_order') ? 'active' : '' }}"
                                                href="{{ route('deposit_order') }}">Deposit Order/Bank Guarantee
                                                Detail</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('tpi_detail') ? 'active' : '' }}"
                                                href="{{ route('tpi_detail') }}">TPI Detail</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
