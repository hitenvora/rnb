                                    ...
                                    <ul class="nav branch_listing">
                                        <li class="nav-item">
                                            <a class="nav-link  {{ Route::is('edit_budgetary_detail') ? 'active' : '' }}"
                                                href="{{ route('edit_budgetary_detail',$project_master->id) }}">Budgetary Detail</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('edit_excess_detail') ? 'active' : '' }}"
                                                href="{{ route('edit_excess_detail',$project_master->id) }}">Excess Detail &
                                                Extra
                                                Detail</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('edit_time_extension') ? 'active' : '' }}"
                                                href="{{ route('edit_time_extension',$project_master->id) }}">Time Limit
                                                Extension</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('edit_work_status') ? 'active' : '' }}"
                                                href="{{ route('edit_work_status',$project_master->id) }}">Work Status</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ Route::is('edit_dlp_period') ? 'active' : '' }}"
                                                href="{{ route('edit_dlp_period',$project_master->id) }}">DLP Period</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
