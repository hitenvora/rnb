                            ...
                            <div class="card-body">
                                <form class="row" method="post" enctype="multipart/form-data" id="master_id">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                ...
                                                                value="{{ $project_master->tle_proposal_letter_no }}">
                                                        </div>
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input type="date" class="form-control"
                                                                ...
                                                                value="{{ $project_master->tle_proposal_letter_date }}">
                                                        </div>
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input type="date" class="form-control"
                                                                ...
                                                                value="{{ $project_master->tle_proposal_extension_date }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="file" class="form-control w-100"
                                                            ...
                                                            value="{{ $project_master->tle_proposal_letter_image }}">
                                                            <a href="{{ asset('uplode_images/time_limit_extension/' . $project_master->tle_proposal_letter_image) }}" target="_blank">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input class="form-control" type="text"
                                                                ...
                                                                placeholder="Enter Letter No."
                                                                value="{{ $project_master->tle_approval_letter_no }}">
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Letter Date</label>
                                                            <input type="date" class="form-control"
                                                                ...
                                                                value="{{ $project_master->tle_approval_letter_date }}">
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Extension Date</label>
                                                            <input type="date" class="form-control"
                                                                ...
                                                                value="{{ $project_master->tle_approval_extension_date }}">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="file" class="form-control w-100"
                                                            ...
                                                            value="{{ $project_master->tle_approval_letter_image }}">
                                                            <a href="{{ asset('uplode_images/time_limit_extension/' . $project_master->tle_approval_letter_image) }}" target="_blank">
                                                                <br>Open Image in New Tab
                                                            </a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <textarea rows="6" class="form-control" id="tle_status" name="tle_status" placeholder="Enter Status">{{ $project_master->tle_status }}</textarea>
                                    </div>
