                                                ...
                                                <td>
                                                    <form class="row" method="post" enctype="multipart/form-data"
                                                        ...
                                                        <input type="date" id="ed_origin_work" name="ed_origin_work"
                                                            class="form-control" value="{{ $project_master->ed_origin_work }}">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="{{ $project_master->ed_tender_cost }}"
                                                        name="ed_tender_cost" id="ed_tender_cost">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="{{ $project_master->ed_paid_amount }}"
                                                        id="ed_paid_amount" name="ed_paid_amount">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="{{ $project_master->ed_expenditure_amount }}"
                                                        name="ed_expenditure_amount" id="ed_expenditure_amount">
                                                </td>
                                                <!-- show total + 9 % value -->
                                                <td>
                                                    <input type="text" class="form-control" value="{{ $project_master->ed_expenditure }}"
                                                        name="ed_expenditure" id="ed_expenditure">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" value="{{ $project_master->ed_work }}" name="ed_work"
                                                        id="ed_work">
                                                </td>
                                                <td>
                                                    <select class="form-select" name="ed_amount_for" id="ed_amount_for">
                                                        <option value="Utility"@selected($project_master->ed_amount_for == 'Utility')>Utility</option>
                                                        <option value="Testing"@selected($project_master->ed_amount_for == 'Testing')>Testing </option>
                                                        <option value="Bill"@selected($project_master->ed_amount_for == 'Bill')>Bill</option>
                                                        <option value="Other"@selected($project_master->ed_amount_for == 'Other')>Other </option>
                                                    </select>
                                                </td>
                                            </tr>
                                            {{-- <tr>
