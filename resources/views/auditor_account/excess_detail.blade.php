                                            ...
                                            <div class="row p-0">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="date" class="form-control" id="ed_division_letter_date"
                                                        name="ed_division_letter_date" value="2023-09-13">
                                                </div>
                                                <div class="col-lg-4">
                                            ...
                                            <div class="row p-0">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="date" class="form-control" id="ed_circle_letter_date"
                                                        name="ed_circle_letter_date" value="2023-09-13">
                                                </div>
                                                <div class="col-lg-4">
                                                    <label class="form-label">Letter Upload</label>
                                                    <div class="input-group">
